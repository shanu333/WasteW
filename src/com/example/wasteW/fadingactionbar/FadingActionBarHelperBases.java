...
public abstract class FadingActionBarHelperBases
{
    ...
    public final <T extends FadingActionBarHelperBases> T actionBarBackground(int drawableResId) {
        mActionBarBackgroundResId = drawableResId;
        return (T)this;
    }

    public final <T extends FadingActionBarHelperBases> T actionBarBackground(Drawable drawable) {
        mActionBarBackgroundDrawable = drawable;
        return (T)this;
    }

    public final <T extends FadingActionBarHelperBases> T headerLayout(int layoutResId) {
        mHeaderLayoutResId = layoutResId;
        return (T)this;
    }

    public final <T extends FadingActionBarHelperBases> T headerView(View view) {
        mHeaderView = view;
        return (T)this;
    }

    public final <T extends FadingActionBarHelperBases> T headerOverlayLayout(int layoutResId) {
        mHeaderOverlayLayoutResId = layoutResId;
        return (T)this;
    }

    public final <T extends FadingActionBarHelperBases> T headerOverlayView(View view) {
        mHeaderOverlayView = view;
        return (T)this;
    }

    public final <T extends FadingActionBarHelperBases> T contentLayout(int layoutResId) {
        mContentLayoutResId = layoutResId;
        return (T)this;
    }

    public final <T extends FadingActionBarHelperBases> T  contentView(View view) {
        mContentView = view;
        return (T)this;
    }

    public final <T extends FadingActionBarHelperBases> T lightActionBar(boolean value) {
        mLightActionBar = value;
        return (T)this;
    }

    public final <T extends FadingActionBarHelperBases> T  parallax(boolean value) {
        mUseParallax = value;
        return (T)this;
    }
    ...
    private void onNewScroll(int scrollPosition) {
        ...
        setAlphaForToolbarTitle(newAlpha);
        addParallaxEffect(scrollPosition);
        
    }

    protected abstract void setAlphaForToolbarTitle(int newAlpha);
